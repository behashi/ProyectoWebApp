 ...
 * Este servlet se utiliza en la implementaci�n del primer hito del proyecto;
 * en �l se debe permitir logearse y ofrecer ciertas funcionalidades a un profesor.
 */
public class loginServlet extends HttpServlet {
	...
	//TODO Crear objeto json con dni y contrase�a(?)
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	//Paso 1 - Pillar usuario y contrase�a del profesor 
		...
		if (responseCode == HttpURLConnection.HTTP_OK) { //Existe la combinaci�n en la api.
			...
			//capturo la cookie de la conexi�n para confirmar que estamos loggeados
			CookieManager cookieManager = new CookieManager();
			CookieHandler.setDefault(cookieManager);
			cookieManager.setCookiePolicy(CookiePolicy.ACCEPT_ALL); //desconozco si es del todo necesario
			
			//recorro la lista de cookies de la conexi�n
			...
			//debug
			System.out.println("El responsecode de la conexi�n es: " + responseCode);
			
			PrintWriter out = response .getWriter();
			//TODO imprimir una pagina html con un p�rrafo hom�logo
			out.println("Autenticaci�n incorrecta");
		}
